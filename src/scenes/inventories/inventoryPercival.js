...
export default class InventoryPercival extends Phaser.Scene{
    ...
    create(){
        ...
        this.inventorySlots = [];
        this.inventorySlots.push(new InventorySlot(this,32,32,'slot',0,false,'SlotSelected'));
        this.inventorySlots.push(new InventorySlot(this,32,135,'slot',0,false,'SlotSelected'));
        this.inventorySlots.push(new InventorySlot(this,32,238,'slot',0,false,'SlotSelected'));
        this.slotSelected = 0;
